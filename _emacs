...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/org/birthday.org" "~/org/tasks.org" "~/org/t-systems.org" "~/org/capture.org")))
 '(org-mobile-files
   (quote
    ("~/org/birthday.org" "~/org/tasks.org" "~/org/org-mode-reference-in.org" "~/org/t-systems.org" "~/org/capture.org" "~/org/weight.org")))
 '(package-selected-packages
   (quote
    (org-context evil-anzu evil-commentary evil-easymotion evil-leader org-ac org-agenda-property org-autolist org-beautify-theme org-bullets org-cliplink org-download org-mobile-sync org-outlook org-screenshot org-table-comment org-toc timesheet anzu evil-org solarized-theme monokai-theme evil))))
(package-initialize)
(custom-set-faces
...
(setq org-mobile-directory "/pi@AEtherpi:/home/pi/org/")
